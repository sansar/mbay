...
(function($){
  ...
  $.mbYTPlayer={
    ...
    width:450,
    controls:{
      play:"<img src='img/controller/play.png'>",
      pause:"<img src='img/controller/pause.png'>",
      mute:"<img src='img/controller/mute.png'>",
      unmute:"<img src='img/controller/unmute.png'>"
    },
...
function playerState(state, el) {
  ...
  if (state==1 && data.isBgndMovie) {
    $(player).css({opacity:data.opacity});
    $(".mbYTP_raster").css({opacity:1,backgroundColor:"transparent"}).fadeIn();
