...
class UploadHandler
{
	...
	function __construct($options = null, $initialize = true, $error_messages = null) {
		$this->options = array(
			...
			'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/'.$_GET['dirpath'].'/',
			'upload_url' => $this->get_full_url().'/files/'.$_GET['dirpath'].'/',
			'user_dirs' => false,
			'mkdir_mode' => 0755,
			'param_name' => 'files',
...
// 		$this->gd_set_image_object($file_path, $src_img);
		return $success;
	}
